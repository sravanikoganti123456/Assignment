...
public class AggregateController {
	...
	public Population getAllStudent()
	{
		...
		public Population getAllStudent123()
		{
			...
			ResponseEntity<Population> result2 = restTemplate.getForEntity("http://localhost:8080/country/getFrancePopulation", Population.class);
			ResponseEntity<Population> result3 = restTemplate.getForEntity("http://localhost:8080/country/getGermanyPopulation", Population.class);
